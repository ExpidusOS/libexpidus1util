 ...
 * Return value :
 **/
typedef gboolean (*ExpidusMatchFunc)   (const gchar *basedir,
                                     const gchar *relpath,
                                     gpointer     user_data);

gchar** expidus_resource_dirs          (ExpidusResourceType type) G_GNUC_MALLOC;
gchar*  expidus_resource_lookup        (ExpidusResourceType type,
                                     const gchar     *filename) G_GNUC_MALLOC;
gchar** expidus_resource_lookup_all    (ExpidusResourceType type,
                                     const gchar     *filename) G_GNUC_MALLOC;
gchar** expidus_resource_match         (ExpidusResourceType type,
                                     const gchar     *pattern,
                                     gboolean         unique) G_GNUC_MALLOC;
gchar** expidus_resource_match_custom  (ExpidusResourceType type,
                                     gboolean         unique,
                                     ExpidusMatchFunc    func,
                                     gpointer         user_data) G_GNUC_MALLOC;
void    expidus_resource_push_path     (ExpidusResourceType type,
                                     const gchar     *path);
void    expidus_resource_pop_path      (ExpidusResourceType type);
gchar*  expidus_resource_save_location (ExpidusResourceType type,
                                     const gchar     *relpath,
