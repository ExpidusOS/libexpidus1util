...
#ifndef __EXPIDUS_UTF8_H__
#define __EXPIDUS_UTF8_H__

#include <glib.h>

G_BEGIN_DECLS

gchar *expidus_utf8_remove_controls  (gchar       *str,
                                   gssize       max_len,
                                   const gchar *end);

gchar *expidus_utf8_strndup          (const gchar *src,
                                   gssize       max_len) G_GNUC_MALLOC;

G_END_DECLS

#endif /* !__EXPIDUS_UTF8_H__ */
