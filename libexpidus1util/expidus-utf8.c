/* $Id$ */
/*-
 * Copyright (c) 2003      Olivier Fourdan <fourdan@expidus.org>
 ...
 **/
gchar*
expidus_utf8_remove_controls (gchar *str, gssize max_len, const gchar *end)
{
  gchar *p;
 ...
 **/
gchar *
expidus_utf8_strndup (const gchar *src,
                   gssize       max_len)
{
  const gchar *s;
