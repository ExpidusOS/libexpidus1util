 ...
 * _expidus_i18n_init:
 *
 * Initializes the libexpidus1util i18n support. We don't call
 * expidus_textdomain() here because we don't want to become the
...
#define __LIBEXPIDUS1UTIL_PRIVATE_C__
